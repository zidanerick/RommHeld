...
def transfer_file(
    ...
    """Transfer one arbitrary local file to an existing mounted-device path."""
    ...
    if final_size != source_size:
        raise IOError(f"Size verification failed: expected {source_size} bytes, got {final_size} bytes")
